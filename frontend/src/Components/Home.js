...
function Home() {
    return ( 
        ...
        <div className="">
            <div className="w-full h-13 carousel rounded-box">
                <div id="slide1" className="carousel-item w-full">
                    <img src={Ribs} alt="Ribs on the gril" className="object-contain overflow-hidden" />
                ...
                {/* <div id="slide2" className="carousel-item relative w-2/3">
                ...
                {/* <div id="slide3" className="carousel-item relative w-2/3">
                ...
                {/* <div id="slide4" className="carousel-item relative w-2/3">
