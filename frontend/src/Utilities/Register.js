                            ...
                            <div className="space-y-5">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <label htmlFor="agree" className="ml-3 text-sm font-medium text-gray-500">
                                        I agree to Sizzle House's <button href="#" title="" className="text-blue-600 hover:text-blue-700 hover:underline">Terms of Service</button> and <button href="#" title="" class="text-blue-600 hover:text-blue-700 hover:underline">Privacy Policy</button>
                                    </label>
                                </div>
