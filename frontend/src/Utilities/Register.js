            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="flex items-center justify-center px-4 py-5 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                    <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                        ...
                        <p>Already have an account? <button onClick={() => props.onFormSwitch('login')} className="text-transparent bg-clip-text bg-blue-700 px-1"> Login!</button></p>
                ...
                <div className="flex items-center justify-center px-4 py-10 sm:py-16 lg:py-24 bg-gray-50 sm:px-6 lg:px-8">
                    <div>
                        <img className="w-full mx-auto" src={Ribs} alt="smoking grill with ribs" />
                    </div>
                </div>
            </div>
        </section>
